...
teacher_dir1 = PATH / './models/TrainAll-2-Nsample-Contrastive_Student/checkpoint-24489'
teacher_dir2 = PATH / './models/babyllama-58M-real'


MODEL_NAME = f'second-baby-similar-parent'
...
teacher2 = LlamaForCausalLM.from_pretrained(teacher_dir2)
