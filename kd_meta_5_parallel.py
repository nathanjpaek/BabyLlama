...
#############
LR = 2.5e-4
BATCH_SIZE = 32  # This batch size will be divided between GPUs
SEQ_LENGTH = 128
TEMPERATURE = 2.0
ALPHA = 0.5
EVAL_SAMPLES = 8192
...
# Initialize models and apply DataParallel
student = LlamaForCausalLM(config)
student = nn.DataParallel(student)  # Enable DataParallel to use multiple GPUs

# Load teacher models and move to multiple GPUs
...
for teacher in teachers:
    teacher = nn.DataParallel(teacher)  # Use DataParallel for teacher models as well
