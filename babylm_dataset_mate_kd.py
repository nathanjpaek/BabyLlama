...
class BabylmDataset(Dataset):
    ...
    def __getitem__(self, i):
        if self.random_chunk:
            ...
            input_ids = self.data[i*self.seq_length+offset:(i+1)*self.seq_length+offset]
        else:
            input_ids = self.data[i*self.seq_length+self.offset:(i+1)*self.seq_length+self.offset]
